    ...
    <section className="bg-gray-50 dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
            <div className="flex flex-col justify-center  mx-7">
                <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 lg:text-5xl dark:text-white">CLASS TRACK uses AI to transform education</h1>
                <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Here at CLASS TRACK we improve classroom management and student engagement. We enhance learning outcomes, contributing to workforce development and economic growth.</p>
                <p className="dark:text-slate-100 font-medium text-lg inline-flex items-center">Get Started 
                ...
                <div className="w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
                    ...
                    <form className="mt-8 space-y-6" action="/">
                        ...
                        <div>
                            ...
                            <input onChange={(e) => setPasskey(e.target.value)} type="password" name="password" id="password" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                        </div>
